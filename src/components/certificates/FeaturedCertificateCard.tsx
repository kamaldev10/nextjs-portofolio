...
const FeaturedCertificateCard: React.FC<FeaturedCardProps> = ({
  ...
  return (
    <Link href="/certificates" className="block group">
      <div className="flex flex-col h-72 w-full overflow-hidden bg-slate-400/30 dark:bg-gray-800/50 border border-slate-500 dark:border-gray-700 rounded-xl shadow-sm transition-all duration-300 ease-in-out group-hover:shadow-lg group-hover:-translate-y-1">
        {/* Image container */}
